...
namespace conct
{
	internal static class TypeCollectionNative
	{
		...
		[DllImport(DynamicLibrary.Name, CharSet = CharSet.Ansi, EntryPoint = "conct_type_collection_load")]
		[return: MarshalAs(UnmanagedType.U1)]
		public static extern bool Load( IntPtr instance, [param: MarshalAs(UnmanagedType.LPStr)] string path );

		[DllImport(DynamicLibrary.Name, CharSet = CharSet.Ansi, EntryPoint = "conct_type_collection_add_value_type")]
		...
		[DllImport(DynamicLibrary.Name, CharSet = CharSet.Ansi, EntryPoint = "conct_type_collection_find_type")]
		...
		[DllImport(DynamicLibrary.Name, CharSet = CharSet.Ansi, EntryPoint = "conct_type_collection_find_interface")]
		...
		[DllImport(DynamicLibrary.Name, CharSet = CharSet.Ansi, EntryPoint = "conct_type_collection_find_struct")]
